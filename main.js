...
class VendimarketApp {
    ...
    generateProducts() {
        ...
        const getPlaceholder = (text, bgColor) => {
            return `data:image/svg+xml,%3Csvg width='400' height='300' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='100%25' height='100%25' fill='%23${bgColor}'/%3E%3Ctext x='50%25' y='50%25' font-family='Arial, sans-serif' font-size='24' fill='white' text-anchor='middle' dy='0.3em'%3E${text}%3C/text%3E%3C/svg%3E`;
        };
        ...
        const categoryData = {
            'Chips & Snacks': {
                ...
                temp: 'ambient',
                image: getPlaceholder('🥔 Chips', 'F39C12')
            },
            'Chocolate & Candy': {
                brands: {
                    'Snickers': {
                ...
                temp: 'ambient',
                image: getPlaceholder('🍫 Chocolate', '8B4513')
            },
            'Protein Bars': {
                brands: {
                    'Quest': {
            ...
            'Soft Drinks': {
                ...
                temp: 'cold',
                image: getPlaceholder('🥤 Drinks', '3498DB')
            },
            'Energy Drinks': {
                brands: {
                    'Red Bull': {
                ...
                temp: 'cold',
                image: getPlaceholder('⚡ Energy', 'E74C3C')
            },
            'Water & Hydration': {
                brands: {
                    'Dasani': {
                ...
                temp: 'cold',
                image: getPlaceholder('💧 Water', '3498DB')
            },
            'Coffee': {
                brands: {
                    'Starbucks': {
                ...
                temp: 'hot',
                image: getPlaceholder('☕ Coffee', '8B4513')
            },
            'Fresh Sandwiches': {
                brands: {
                    'Daily Fresh': {
            ...
            'Cookies': {
                ...
                temp: 'ambient',
                image: getPlaceholder('🍪 Cookies', 'D4A574')
            },
            'Gum & Mints': {
                brands: {
                    'Orbit': {
                ...
                temp: 'ambient',
                image: getPlaceholder('🍬 Gum', '2ECC71')
            }
        };
