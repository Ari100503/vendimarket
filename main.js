...
class VendimarketApp {
    ...
    generateProducts() {
        ...
        const categoryData = {
            'Chips & Snacks': {
                ...
                temp: 'ambient',
                image: 'https://kimi-web-img.moonshot.cn/img/i.ytimg.com/1d1a8f897d2147caa8240dc401d879a89dd1ee34.jpg'
            },
            'Chocolate & Candy': {
                brands: {
                    'Snickers': {
                ...
                temp: 'ambient',
                image: 'https://kimi-web-img.moonshot.cn/img/target.scene7.com/cafa74390df5db29ca35c34f67255773ef93de4b'
            },
            'Protein Bars': {
                brands: {
                    'Quest': {
                ...
                temp: 'ambient',
                image: 'resources/healthy-bars.jpg'
            },
            'Soft Drinks': {
                brands: {
                    'Coca-Cola': {
                ...
                temp: 'cold',
                image: 'https://kimi-web-img.moonshot.cn/img/static-www.adweek.com/9841399f24f3ace3e2ae0e91de314461c6588333.jpg'
            },
            'Energy Drinks': {
                brands: {
                    'Red Bull': {
                ...
                temp: 'cold',
                image: 'https://kimi-web-img.moonshot.cn/img/fortune.com/a41f89dc99f86b6173c9d6624eacabc8c656dcaf.jpg'
            },
            'Water & Hydration': {
                brands: {
                    'Dasani': {
                ...
                temp: 'cold',
                image: 'https://kimi-web-img.moonshot.cn/img/www.foodrepublic.com/009739ca1d598cc5d2a2104c21c1adfa9c1dbe7a.jpg'
            },
            'Coffee': {
                brands: {
                    'Starbucks': {
                ...
                temp: 'hot',
                image: 'https://kimi-web-img.moonshot.cn/img/esajee.com/8cdbef5c4728097cdd689945f644398ad7aa9df3.jpg'
            },
            'Fresh Sandwiches': {
                brands: {
                    'Daily Fresh': {
                ...
                temp: 'cold',
                image: 'resources/fresh-food.jpg'
            },
            'Ice Cream': {
                brands: {
                    'Ben & Jerry\'s': {
                ...
                temp: 'frozen',
                image: 'resources/frozen-treats.jpg'
            },
            'Cookies': {
                brands: {
                    'Oreo': {
                ...
                temp: 'ambient',
                image: 'https://kimi-web-img.moonshot.cn/img/elavegan.com/e9a7233df8dcca10b67947391285c7da502fd732.jpg'
            },
            'Gum & Mints': {
                brands: {
                    'Orbit': {
                ...
                temp: 'ambient',
                image: 'https://kimi-web-img.moonshot.cn/img/m.media-amazon.com/ba255619d4dd3050f3c5dba49958a18728144ddf.jpg'
            }
        };
    ...
    initStoreMap() {
        ...
        const map = L.map('storeMap').setView([40.7128, -74.0060], 13);
        ...
        const stores = [
            { name: 'Vendimarket Downtown', lat: 40.7589, lng: -73.9851, status: 'Open 24/7' },
            { name: 'Vendimarket Midtown', lat: 40.7505, lng: -73.9934, status: 'Open 24/7' },
            { name: 'Vendimarket Uptown', lat: 40.7831, lng: -73.9712, status: 'Open 24/7' },
            { name: 'Vendimarket Brooklyn', lat: 40.6892, lng: -73.9442, status: 'Open 24/7' }
        ];
